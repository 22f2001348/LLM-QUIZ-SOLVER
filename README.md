...
```bash
git clone https://github.com/22f2001348/LLM-QUIZ-SOLVER.git
cd LLM-QUIZ-SOLVER
```
...
curl -X POST http://localhost:7860/solve \
  ...
  -d '{
    "email": "your.email@example.com",
    "secret": "your_secret_string",
    "url": "https://test1-opal-eight-55.vercel.app/"
  }'
```
...
- Check logs to verify agent completed the quiz
- Agent should submit final answer automatically
...
For questions or issues, please open an issue on the [GitHub repository](https://github.com/22f2001348/LLM-QUIZ-SOLVER).